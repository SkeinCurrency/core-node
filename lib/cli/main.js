...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the SkeinCurrency database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make core-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `core-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ core-node add wallet-service');
      console.log('    $ core-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ core-node remove wallet-service');
      console.log('    $ core-node remove insight-api');
      console.log();
    });
