...
/**
 * Will return the path and default core-node configuration. It will search for the
 * configuration file in the "~/.skeincore" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.skeincore');
  var defaultConfigFile = path.resolve(defaultPath, './core-node.json');
